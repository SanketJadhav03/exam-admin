    ...
    <div class="container-fluid">
        <div class="card mt-2">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3>Syllabus</h3>
                <div>
                    <a href="{{route('syllabus.create')}}" class="btn btn-primary">Create Syllabus</a>
                </div>
            </div>
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-header d-flex border-top rounded-0 flex-wrap py-2">
                        <div class="me-5 ms-n2 pe-5">
                            ...
                            <div id="DataTables_Table_0_filter" class="dataTables_filter"><label><input type="search"
                                        class="form-control" placeholder="Search Syllabus"
                    ...
                    <table class="datatables-products table dataTable no-footer dtr-column" id="DataTables_Table_0"
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text- ">
                                        <label class="switch switch-success">
                                            <input type="checkbox" data-id="{{ $syllabus->syallabus_id }}" class="switch-input  status-toggle" {{ $syllabus->syllabus_status ? 'checked' : '' }}>
                                            ...
                                            <span class="switch-label">
                                                {{ $syllabus->syllabus_status ? 'Active' : 'Inactive' }}
                                            </span>
                                        </label>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{route('syllabus.edit' , $syllabus->syallabus_id)}}"
                                                class="btn btn-sm btn-primary me-2 rounded" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            
                                            <form action="{{route('syllabus.destroy', $syllabus->syallabus_id)}}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">No Syllabus found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.status-toggle').forEach(toggle => {
                toggle.addEventListener('change', function() {
                    ...
                    axios.post('/admin/category/status', {
                            id: categoryId,
