    ...
    <div class="container-fluid ">
        <div class="card mt-2">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3>Create Custom POst</h3>
                <div>
                    <a href="/admin/custom_post" class="btn btn-primary">Back to Custom Post</a>
                </div>
            </div>
            <div class="card-body ">
                @if (session('danger'))
                ...
                @endif
                <form action="/admin/custom_post/store" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class=" -group mb-3">
                                ...
                                <select id="select2Basic" class="select2 form-select form-select-lg"
                                    data-allow-clear="true" name="custom_id">
