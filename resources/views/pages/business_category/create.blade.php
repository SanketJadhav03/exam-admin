    ...
    <div class="container-fluid ">
        <div class="card mt-2">
            ...
            <div class="card-body ">
                ...
                @endif
                <form action="/admin/business_category/store" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary ms-2"> <i class="fa fa-save me-2"></i> Save Business Category</button>
                    </div>
                </form>
            </div>
        </div>
