        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->routeIs('businessCategoryList') || request()->routeIs('businessSubCategoryList') || request()->routeIs('businessPostList') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons ti ti-building-store"></i> <!-- Business icon -->
                            <div data-i18n="Business">Business</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ request()->routeIs('businessCategoryList') ? 'active' : '' }}">
                                <a href="/admin/business_category" class="menu-link">
                                    <div data-i18n="Business Category">Business Category</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('businessSubCategoryList') ? 'active' : '' }}">
                                <a href="/admin/business_sub_category" class="menu-link">
                                    <div data-i18n="Business Sub Category">Business Sub Category</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->routeIs('businessPostList') ? 'active' : '' }}">
                                <a href="/admin/business_post" class="menu-link">
                                    <div data-i18n="Business Post">Business Post</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    
                    <li class="menu-item {{ request()->routeIs('languageList') ? 'active' : '' }}">
                        ...
                        <div class="container-xxl">
                            <div
                                ...
                                <div>
                                    ...
                                    , made with ❤️ by <a href="https://ajspire.com" target="_blank"
                                        class="fw-medium">Ajspire Technologies Pvt Ltd</a>
                                        Developers
                                </div>
                                <div class="d-none d-lg-inline-block">
                                     
                                    <div
                                        class="footer-link d-none d-sm-inline-block">Version 1.0</div>
                                </div>
                            </div>
                        </div>
                    </footer>
